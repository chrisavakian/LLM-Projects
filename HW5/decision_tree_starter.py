...
class DecisionTree:
    ...
    def __init__(self, max_depth=3, feature_labels=None):
        ...
        self.split_feature = None  # Index of the feature to split on
        self.threshold = None  # Threshold to split the feature
        self.label = None  # Label for leaf nodes
        self.depth = 0  # Current depth of the node
    ...
    def information_gain(self, X, y, thresh):
        # Split the dataset
        left_indices = [i for i in range(len(X)) if X[i][self.split_feature] < self.threshold]
        right_indices = [i for i in range(len(X)) if X[i][self.split_feature] >= self.threshold]
